...
if (new Date - user.crime < cooldown) throw `⏰ No puedes realizar un *Crimen* en este momento. Debes aguarder *${msToTime((user.crime + cooldown) - new Date())}*`;
...
└────────────── `, null, { mentions: [userID] });
     ...
     user.coin -= multa;
      m.reply(`🚔 ¡Oh no! Seu crime falhou y te han multado con *-${multa}* 🪙`);
    }
